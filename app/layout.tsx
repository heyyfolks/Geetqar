...
export const metadata: Metadata = {
  ...
  title: {
    default: 'GEETQAR — Music Beyond Sound',
    template: '%s — GEETQAR',
  },
  ...
  openGraph: {
    ...
    description: 'Listen. See it move. Enter the GEETQAR world.',
    url: siteUrl,
    siteName: 'GEETQAR',
    type: 'website',
    locale: 'en_US',
  ...
  twitter: {
    ...
    title: 'GEETQAR — Music Beyond Sound',
    description: 'The official GEETQAR music world.',
  },
...
const structuredData = {
  ...
  url: siteUrl,
  sameAs: [
    'https://www.instagram.com/geetqar/',
    'https://www.youtube.com/@geetqar',
  ],
}
